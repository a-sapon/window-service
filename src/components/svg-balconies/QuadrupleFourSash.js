...
const QuadrupleFourSash = ({ onHandleClick }) => (
  <div onClick={onHandleClick} className={styles.windowWrapper}>
    <div data-type='QuadrupleFourSash' data-sash='4' className={styles.window}>
      <div
      ...
      >
        ...
        <g>
          ...
          ></polygon>
          <polygon
            points='40 40 100 100 555 100 615 40'
            stroke='#0d0d0d'
            fill='#f2f2f2'
            strokeWidth='1'
          ></polygon>
          <polygon
            points='615 40 555 100 555 1100 615 1160'
            stroke='#0d0d0d'
            fill='#f2f2f2'
            strokeWidth='1'
          ></polygon>
          <polygon
            points='40 1160 100 1100 555 1100 615 1160'
            stroke='#0d0d0d'
            fill='#f2f2f2'
            strokeWidth='1'
          ></polygon>
        ...
        <g>
          <polygon
            points='1883 40 1943 100 1943 1100 1883 1160'
            stroke='#0d0d0d'
            fill='#f2f2f2'
            strokeWidth='1'
          ></polygon>
          <polygon
            points='1883 40 1943 100 2398 100 2458 40'
            stroke='#0d0d0d'
            fill='#f2f2f2'
            strokeWidth='1'
          ></polygon>
          <polygon
            points='2458 40 2398 100 2398 1100 2458 1160'
            stroke='#0d0d0d'
            fill='#f2f2f2'
            strokeWidth='1'
          ></polygon>
          <polygon
            points='1883 1160 1943 1100 2398 1100 2458 1160'
            stroke='#0d0d0d'
            fill='#f2f2f2'
            strokeWidth='1'
          ></polygon>
...
export default QuadrupleFourSash;
