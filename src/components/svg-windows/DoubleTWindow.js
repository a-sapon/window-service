...
const DoubleTWindow = ({ onHandleClick }) => (
  <div onClick={onHandleClick} className={styles.windowWrapper}>
    <div data-type='Двустворчатое Т-образное окно, открывание с обеих сторон' data-sash='2' className={styles.window}>
      ...
      >
        ...
        <g>
          ...
          ></polygon>
          <polygon
            points='40 530 100 590 530 590 590 530'
            stroke='#0d0d0d'
            fill='#f2f2f2'
            strokeWidth='1'
          ></polygon>
          <polygon
            points='590 530 530 590 530 1460 590 1520'
            stroke='#0d0d0d'
            fill='#f2f2f2'
            strokeWidth='1'
          ></polygon>
          <polygon
            points='40 1520 100 1460 530 1460 590 1520'
            stroke='#0d0d0d'
            fill='#f2f2f2'
            strokeWidth='1'
          ></polygon>
